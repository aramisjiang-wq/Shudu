...
**完整结构说明：** 📁 [PROJECT_STRUCTURE.md](./PROJECT_STRUCTURE.md)  
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/aramisjiang-wq/Shudu)
...
**其他部署方案：**
- GitHub Pages（仅前端）- [查看说明](./docs/deployment/GITHUB_PAGES_NOTE.md)
- Render / Railway（全栈）
- 分离部署（前端 + 后端）

⚠️ **重要提示：** GitHub Pages 不支持后端 API，推荐使用 Vercel 进行全栈部署。
